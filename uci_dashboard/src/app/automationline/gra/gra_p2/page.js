...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const instanceId = "cbae6cff-55a9-4972-8b4e-173bf7308495";
      const formData = {};
      ...
      const machineStatusMappings = {
        "Auto Mode": "AUTO_MODE",
        "Robot-3 Ready": "R3_RDY",
        "Robot-4 Ready": "R4_RDY",
        "Robot-5 Ready": "R5_RDY",
        "Communication Ok": "COMM_OK",
        "Robot System Ok": "ROBT_SYS_OK",
        "All System Ok": "ALL_SYS_OK",
        "Robot-3 Alarm": "R3_ALRM",
        "Robot-4 Alarm": "R4_ALRM",
        "Robot-5 Alarm": "R5_ALRM"
      };

      const operationalDetailsMappings = {
        "System Fault Duration": "SYS_FALT_TIME",
      "PIN Load Fix-1 Count": "PIN_LD_F1_CNT",
      "PIN Load Fix-2 Count": "PIN_LD_F2_CNT",
      "Robot-3 Idle Duration": "R3_IDL_TIME",
      "Robot-4 Idle Duration": "R4_IDL_TIME",
      "Robot-5 Idle Duration": "R5_IDL_TIME"
      };
