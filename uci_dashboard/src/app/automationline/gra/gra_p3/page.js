...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      const instanceId = "890482da-ef78-4792-bf08-bd10692d7248";
      const formData = {};
      ...
      const machineStatusMappings = {
        "Auto Mode": "AUTO_MODE",
      "Robot-6 Ready": "R6_RDY",
      "Robot-7 Ready": "R7_RDY",
      "Communication Ok": "COMM_OK",
      "Robot System Ok": "ROBT_SYS_OK",
      "All System Ok": "ALL_SYS_OK",
      "Robot-6 Alarm": "R6_ALRM",
      "Robot-7 Alarm": "R7_ALRM"
      };

      const operationalDetailsMappings = {
        "System Fault Duration": "SYS_FALT_TIME",
      "PIN Pressing M/C-1 Idle Duration": "PIN_PRS_M1_IDL_T",
      "PIN Pressing M/C-2 Idle Duration": "PIN_PRS_M2_IDL_T",
      "PIN Pressing M/C-1 Output Count": "PIN_PRS_M1_OPCNT",
      "PIN Pressing M/C-2 Output Count": "PIN_PRS_M2_OPCNT",
      "Part Ok Count": "PART_OK_CNT",
      "Part Not Ok Count": "PART_NOT_OK_CNT",
      "Robot-6 Idle Duration": "R1_IDL_TIME",
      "Robot-7 Idle Duration": "R2_IDL_TIME"
      };
    ...
    <div className="flex flex-col items-center p-6 bg-gray-100 overflow-scroll w-full justify-center mb-20">
      <div className="w-full bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <div className="flex gap-10 w-full items-center justify-center">
          <div>
            {/* <Image src="/pngwing.com.png" width={140} height={100} alt="machine hand"  /> */}
