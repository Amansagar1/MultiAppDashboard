    ...
    <div className={`w-full border ${isDarkMode ? 'border-dark bg-gray-800  text-dark' : 'border-gray-200 bg-white text-black'} relative p-1`}>
      <div className="w-full flex  justify-between items-center px-2">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div
            onClick={toggleMenu}
            className={`rounded-full w-8 h-8 flex items-center justify-center mr-2 hover:text-blue-900 hover:scale-105 cursor-pointer ${isDarkMode ? 'bg-sky-600' : 'bg-sky-500'}`}
          >
          ...
          {isMenuOpen && (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <Image src={navlogo} alt="Logo" className="w-40 h-10" />
                <button
