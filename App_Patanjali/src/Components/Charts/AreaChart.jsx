...
//             name: key,
//             type: 'line',
//             stack: stackAreas ? 'Total' : undefined,
//             smooth: curveType === 'curveLinear' ? true : curveType === 'curveStep' ? 'step' : false,
...
//     useEffect(() => {
//         if (!data) {
//             console.error("No data provided to AreaChart component");
//             return;
//         }
...
//             }
//         };
//     }, [data, backgroundColor, showAnimation, showBorder, borderSize,
//         borderColor, name, nameSize, nameColor, nameBold, nameItalic,
//         titlePosition, showLegend, legendPosition, showGridLines,
//         gridLineColor, xAxisLabel, xAxisLabelSize, xAxisLabelColor,
//         yAxisLabel, yAxisLabelSize, yAxisLabelColor, showDataPoints,
//         colorScheme, showArea, enableZoom, isDarkMode, activeLegend]);
...
const AreaChart = ({
    ...
    const processData = (data) => {
        ...
        const seriesData = categories.map((key) => ({
            ...
            smooth: curveType === 'curveLinear' ? true : curveType === 'curveStep' ? 'step' : false,
            symbol: showDataPoints ? 'circle' : 'none',
            symbolSize: 6,  // Optimized size for better visibility
            lineStyle: {
                width: 2,  // Optimized line width for clarity
            ...
            itemStyle: {
                color: colorMapRef.current[key],
                borderWidth: 2,  // Improved data point border
