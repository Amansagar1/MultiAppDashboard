...
//     if (onTimeRangeApply) {
//       onTimeRangeApply({ from: fromDate.toISOString(), to: now.toISOString() }, range);
//     }
//     onClose();
//   };
...
//   return (
//     <div style={{ position: "absolute", zIndex: 1000 }} className={`absolute top-14 right-5 z-50 flex items-center justify-center bg-black bg-opacity-50 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
...
//               Quick ranges
//             </h2>
//             <ul className={`space-y-2 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
